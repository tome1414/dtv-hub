---
title: "DTV e-Visa Form: Fields That Commonly Cause Confusion"
...
secondary_keywords:
  ...
  - "DTV application form questions"
  - "DTV form occupation field"
  - "DTV form accommodation Thailand"
article_type: "guide"
...
avoid_topics:
  - "massage-dtv"
  - "discord-main-cta"
excerpt: "The Thai e-Visa form is straightforward for most fields — but a few trip up almost every DTV applicant. This guide covers the fields that cause the most confusion: visa type selection, current location proof, occupation, accommodation, and intended entry date."
read_time_minutes: 8
---
...
For a complete walkthrough of the entire form structure, see the [e-Visa form guide](/en/guide/evisa-form).
...
See [Where to Apply for the DTV](/en/blog/dtv-where-to-apply) for more on embassy selection and third-country applications.
...
The full DTV application process is covered in the [DTV application guide](/en/blog/dtv-application).

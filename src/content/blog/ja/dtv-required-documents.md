...
日本で発行する場合、警察証明書（Police Clearance Certificate）が一般的な選択肢の一つですが、公館が求める具体的な要件は申請先公館の最新案内で確認してください。
...
A. 2026年8月31日以降、Certificate of Criminal Record ClearanceはDTVのSupporting Documentsとして追加されています。どの国の証明書を使用するか、有効期間・発行機関・発行形式については申請先公館の案内を確認してください。公館によって具体的な要件が異なります。

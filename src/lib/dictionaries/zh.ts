      ...
      categories: [
        {
          ...
          questions: [
            ...
            },
            {
              ...
              a: '这份材料证明的不是您的"固定住址"，而是"申请时合法居留于该领事馆管辖区域"。DTV可在泰国境外的任何泰国领事馆或大使馆申请，因此从第三国申请也完全没有问题。\n\n【具体示例】\n① 在本国领事馆申请 → 驾驶证、水电费账单等\n② 在越南河内领事馆申请（越南滞留中）→ 越南旅游签证 + 酒店收据，或飞往泰国的机票\n③ 从其他第三国申请 → 该国有效签证、住宿证明或机票之一\n\n※ 第三国申请规定因领事馆而异（例如：首尔泰国大使馆可能不接受外国人持旅游签证申请）。申请前请务必直接向相关领事馆确认。\n\n※ 阿富汗、伊朗、伊拉克、尼日利亚、巴基斯坦等被泰国政府列为"特别审查对象国"的国籍人士在第三国申请时可能受到限制。可能需要在本国申请或提交无犯罪记录证明等额外文件。如有疑虑，请提前联系我们。',
            },
          ],
        },
        {
        ...
        },
        {
          ...
          questions: [
            {
              q: '如果签证被拒怎么办？',
              a: '使用代理服务，我们退还100%学费。不使用代理服务，退还50%。10,000泰铢签证申请费在两种情况下都不可退款。（韩国、马来西亚、新加坡、突尼斯国籍人士根据与泰国的双边协议可免除此费用。）',
            },
            {
              q: '不购买代理服务可以退款吗？',
            ...
            {
              q: '仅凭余额证明是否足够，还是还需要提供交易流水？',
              a: '申请时必须提交显示50万泰铢以上余额的银行证明。\n\n近年来，越来越多的领事馆要求同时提交过去3个月的银行交易明细（流水账单）。\n\n建议提前同时准备余额证明和交易明细，以备不时之需。',
            },
          ],
        },
        {
        ...
        },
        {
          ...
          questions: [
            {
              q: '我听说泰国免签证停留期从60天将发生变化，是怎么回事？',
              a: '泰国内阁于2026年5月19日正式批准了针对日本、欧美等大多数国家将60天免签证制度废止并恢复至30天的修改案（皇家公报刊载15天后正式生效）。\n\n韩国、巴西、秘鲁、阿根廷、智利等5国依据双边协议不受此次变更影响，继续保持90天免签证停留。\n\n获得DTV签证后，每次入境最多可停留180天（通过当地延期手续最长约1年），DTV的价值比以往任何时候都更加重要。',
            },
            {
              q: '最低年龄是多少？',

...
const content = {
  ...
  zh: {
    badge: '泰国政府认证项目',
    title: 'Golf DTV适合您吗？',
    subtitle: '5项检查，1分钟即可确认',
    intro: 'Golf DTV是通过参加泰国政府认证的高尔夫学校项目，从而获取DTV签证（长期居留签证）的服务。无需提供自由职业证明材料，受到上班族、主妇、退休人员等各类人群的广泛欢迎。',
    suitableTitle: '适合以下人群',
    suitable: [
      '计划长期居留泰国（3个月以上）',
      '难以准备自由职业收入证明（上班族、主妇等）',
      '有高尔夫经验或对高尔夫感兴趣',
      '重视顺畅的签证申请流程',
      '考虑退休后在海外长期生活',
      '正在研究在泰国的资产管理或税务居留',
    ],
    unsuitableTitle: '以下情况可能不适合',
    unsuitable: [
      '对高尔夫毫无兴趣，不希望参加任何项目',
      '仅计划短期停留（1〜2个月）',
      '已具备远程办公证明材料，可通过自由职业路径申请',
    ],
    program: {
      title: 'Golf DTV项目概要',
      items: [
        { label: '地点', value: '泰国曼谷近郊高尔夫球场' },
        { label: '级别', value: '初学者至有经验者均可' },
        { label: '文件', value: '发放入学许可证和推荐信' },
        { label: '保证', value: '提供全额退款保证方案' },
        { label: '实绩', value: '众多DTV获签支持案例' },
      ],
    },
    faq: [
      { q: '高尔夫初学者也可以吗？', a: '完全可以。项目设有初学者课程，高尔夫水平不影响签证审查。' },
      { q: '项目结束后可以继续在泰国居留吗？', a: '可以。DTV签证有效期5年，每次入境最长可居留180天。项目结束后可继续居留。' },
      { q: '提供中文支持吗？', a: '提供多语言支持和咨询服务。欢迎先预约免费咨询。' },
    ],
    ctaPrimary: '免费咨询',
    ctaSecondary: '查看申请流程',
  },
